...
DEPLOYMENT_VARIABLES = {
    ...
    "APP_URL": ("APP_URL", "WEBSITE_DOMAIN", "NEXT_PUBLIC_APP_URL"),
    "API_URL": ("API_URL", "API_DOMAIN", "NEXT_PUBLIC_BACKEND_URL"),
    "ADMIN_EMAIL": ("ADMIN_EMAIL",),
    "ADMIN_PASSWORD": ("ADMIN_PASSWORD",),
    "AUTOPAY_CRON_SECRET": ("AUTOPAY_CRON_SECRET", "CRON_SECRET"),
